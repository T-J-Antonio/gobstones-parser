...
numberOfBalls Red board = red $ (!! currentCell board) $ cells board
numberOfBalls Blue board = blue $ (!! currentCell board) $ cells board
numberOfBalls Green board = green $ (!! currentCell board) $ cells board
numberOfBalls Black board = black $ (!! currentCell board) $ cells board
